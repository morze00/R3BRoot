...
void R3BTrackingS522::SetFrsEllipticPIDCut(double meanZ, double rZ, double meanAoZ, double rAoZ)
{
    FrsCutMeanZ = meanZ;
    FrsCutRadiusZ = rZ;
...
bool R3BTrackingS522::IsInsideFrsEllipticPIDCut(double z, double aoz)
{
